"""
Django settings for django_sre project.
...
WSGI_APPLICATION = 'django_sre.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': '/usr/local/var/log/django-sre.log',
            'maxBytes': 1024000,
            'backupCount': 5
        },
        'mail_admins': {
